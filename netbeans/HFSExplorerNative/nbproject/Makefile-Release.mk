...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk dist/Release/MinGW-Windows/libHFSExplorerNative.dll

dist/Release/MinGW-Windows/libHFSExplorerNative.dll: ${OBJECTFILES}
...
${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/src/win32/llio/llio_common.o: nbproject/Makefile-${CND_CONF}.mk ../../src/win32/llio/llio_common.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/src/win32/llio/llio_common.o ../../src/win32/llio/llio_common.c
...
${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/src/win32/launcher/launcher.o: nbproject/Makefile-${CND_CONF}.mk ../../src/win32/launcher/launcher.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/src/win32/launcher/launcher.o ../../src/win32/launcher/launcher.cpp
...
${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/src/win32/llio/org_catacombae_storage_io_win32_Win32FileStream.o: nbproject/Makefile-${CND_CONF}.mk ../../src/win32/llio/org_catacombae_storage_io_win32_Win32FileStream.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/src/win32/llio
	${RM} $@.d
	$(COMPILE.c) -O2  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/src/win32/llio/org_catacombae_storage_io_win32_Win32FileStream.o ../../src/win32/llio/org_catacombae_storage_io_win32_Win32FileStream.c
...
${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/src/win32/llio/org_catacombae_storage_io_win32_ReadableWin32FileStream.o: nbproject/Makefile-${CND_CONF}.mk ../../src/win32/llio/org_catacombae_storage_io_win32_ReadableWin32FileStream.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/src/win32/llio
	${RM} $@.d
	$(COMPILE.c) -O2  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/src/win32/llio/org_catacombae_storage_io_win32_ReadableWin32FileStream.o ../../src/win32/llio/org_catacombae_storage_io_win32_ReadableWin32FileStream.c
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/MinGW-Windows/libHFSExplorerNative.dll
