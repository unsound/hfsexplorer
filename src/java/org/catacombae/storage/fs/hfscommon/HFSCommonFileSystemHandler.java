...
public abstract class HFSCommonFileSystemHandler extends FileSystemHandler {
    ...
    */
    ...
    static String sfmRemap(String nodeName, boolean unwrap) {
        final char[] wrapTable = {
    ...
    protected String getLogicalName(String onDiskName) {
        ...
        if(posixNames) {
            ...
            if(sfmSubstitutions) {
                logicalName = sfmRemap(logicalName, false);
            }
        }
    ...
    protected String getOnDiskName(String logicalName) {
        ...
        if(posixNames) {
            ...
            if(sfmSubstitutions) {
                logicalName = sfmRemap(logicalName, true);
            }
        }
