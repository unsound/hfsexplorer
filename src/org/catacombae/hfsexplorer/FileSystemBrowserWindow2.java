...
import org.catacombae.hfsexplorer.unfinished.FileSystemBrowser.RecordType;
...
public class FileSystemBrowserWindow2 extends JFrame {
    ...
    public FileSystemBrowserWindow2() {
	this(null);
    }
    public FileSystemBrowserWindow2(final DebugConsoleWindow dcw) {
	super(TITLE_STRING);
	...
	if(WindowsLowLevelIO.isSystemSupported()) {
	    ...
	    loadFSFromDeviceItem.addActionListener(new ActionListener() {
			...
			SelectWindowsDeviceDialog deviceDialog = 
			    new SelectWindowsDeviceDialog(FileSystemBrowserWindow2.this,
							  true,
	...
	loadFSFromFileItem.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent ae) {
		    ...
		    if(fileChooser.showOpenDialog(FileSystemBrowserWindow2.this) == 
	...
	fsInfoItem.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent ae) {
			...
			JOptionPane.showMessageDialog(FileSystemBrowserWindow2.this, "No file system loaded.",
						      "Error", JOptionPane.ERROR_MESSAGE);
		}		
	    });
		...
		public void actionPerformed(ActionEvent ae) {
		    ...
		    if(f.exists()) {
                        try {
                            ...
                            ex.printStackTrace();
                            Logger.getLogger(FileSystemBrowserWindow2.class.getName()).log(Level.WARNING, null, ex);
                        }
                    }
		}
	    });
	...
	aboutItem.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent ae) {
		    ...
		    JOptionPane.showMessageDialog(FileSystemBrowserWindow2.this, message, 
...
// 				System.err.println(" in directory \"" + tempDir + "\"");
				...
				JOptionPane.showMessageDialog(FileSystemBrowserWindow2.this, "Open failed. Exception caught:\n" +
							      stackTrace,
							      "Error", JOptionPane.ERROR_MESSAGE);
			    }
			}
	    ...
	    alOpen = new ActionListener() {
			...
			if(extract(rec, tempDir, NullProgressMonitor.getInstance()) == 0) {
				...
				fopFrame.dispose();
                                ...
                                JOptionPane.showMessageDialog(FileSystemBrowserWindow2.this, "Could not find a handler to open the file with.\n" +
...
// 				System.err.println(" in directory \"" + tempDir + "\"");
	...
	try {
		...
		if(fileChooser.showDialog(FileSystemBrowserWindow2.this, "Extract here") == JFileChooser.APPROVE_OPTION) {
...
// 		    System.out.println("CLOSED_OPTION: \"" + JOptionPane.CLOSED_OPTION + "\"");
    ...
    private class FileSystemProvider implements FileSystemBrowser.FileSystemProvider<FSEntry> {
        ...
        public void actionDoubleClickFile(Record<FSEntry> record) {
            ...
            if(entry instanceof FSFile) 
                FileSystemBrowserWindow2.this.actionDoubleClickFile((FSFile)entry);
            else
        ...
        public void actionExtractToDir(List<Record<FSEntry>> recordList) {
            ...
            FileSystemBrowserWindow2.this.actionExtractToDir(fsEntryList, true, false);
        }

        public void actionGetInfo(List<Record<FSEntry>> recordList) {
            if(recordList.size() == 1)
                FileSystemBrowserWindow2.this.actionGetInfo(recordList.get(0).getUserObject());
        ...
        public JPopupMenu getRightClickRecordPopupMenu(final Record<FSEntry> record) {
            ...
            infoItem.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    FileSystemBrowserWindow2.this.actionGetInfo(record.getUserObject());
                }
            });
            jpm.add(infoItem);
            ...
            dataExtractItem.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    FileSystemBrowserWindow2.this.actionExtractToDir(oneItemList, true, false);
                }
            });
            ...
            resExtractItem.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    List<FSEntry> oneItemList = new ArrayList<FSEntry>(1);
                    oneItemList.add(record.getUserObject());
                    FileSystemBrowserWindow2.this.actionExtractToDir(oneItemList, false, true);
                }
            });
            ...
            bothExtractItem.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    List<FSEntry> oneItemList = new ArrayList<FSEntry>(1);
                    oneItemList.add(record.getUserObject());
                    FileSystemBrowserWindow2.this.actionExtractToDir(oneItemList, true, true);
                }
            });
