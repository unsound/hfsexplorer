...
public class FileSystemRecognizer {
    ...
    private static final short SIGNATURE_HFSX =     (short)0x4858; // ACII: 'HX'
    
    public static enum FileSystemType { MFS, HFS, HFS_PLUS, HFSX, UNKNOWN };
	...
	case SIGNATURE_HFS: return FileSystemType.HFS;
