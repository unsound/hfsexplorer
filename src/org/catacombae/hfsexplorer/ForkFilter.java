...
//     }
    public ForkFilter(CommonHFSForkData forkData, CommonHFSExtentDescriptor[] extentDescriptors,
        ...
        this(forkData.getLogicalSize(), extentDescriptors, sourceFile, fsOffset, blockSize);
    }
	...
	for(extIndex = 0; extIndex < extentDescriptors.length; ++extIndex) {
		...
		offset = fsOffset + cur.getStartBlock()*blockSize + bytesToSkip;
		break;
	    }
	}
    ...
    public long length() { return forkLength; }
