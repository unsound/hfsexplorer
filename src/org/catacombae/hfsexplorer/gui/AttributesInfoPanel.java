 ...
 * @author  Erik
 */
public class AttributesInfoPanel extends javax.swing.JPanel {
            ...
            public void valueChanged(TreeSelectionEvent te) {
                ...
                if(o instanceof DefaultMutableTreeNode) {
                    ...
                    if(o2 instanceof BTNodeStorage) {
                        ...
                        AttributesLeafStorage leafStorage =
                                (AttributesLeafStorage) o2;
                        CommonHFSAttributesLeafRecord rec = leafStorage.getRecord();
    ...
    private static class AttributesLeafStorage {
        ...
        public AttributesLeafStorage(int recordNumber, int recordOffset,
                int recordSize, CommonHFSAttributesLeafRecord rec,
                String text)
        {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .add(catalogTreeScroller, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 357, Short.MAX_VALUE)
        );
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(org.jdesktop.layout.GroupLayout.TRAILING, catalogTreeScroller, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 328, Short.MAX_VALUE)
        );
        ...
        descriptionLabel.setText("View of the attributes file's B*-tree:");
