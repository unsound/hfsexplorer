...
import org.catacombae.hfsexplorer.types.HFSDate;
...
public class MasterDirectoryBlock {
	...
	ps.println(prefix + " drCrDate: " + getDrCrDate() + " (" + getDrCrDateAsDate() + ")");
	ps.println(prefix + " drLsMod: " + getDrLsMod() + " (" + getDrLsModAsDate() + ")");
