...
public class MasterDirectoryBlock implements StructElements {
    ...
    public Dictionary getStructElements() {
        ...
        db.add("drSigWord", new ASCIIStringField(drSigWord));
        db.add("drCrDate", new HFSDateField(drCrDate));
        db.add("drLsMod", new HFSDateField(drLsMod));
        db.add("drAtrb", getAttributeElements());
        db.addUIntBE("drNmFls", drNmFls);
        db.addUIntBE("drVBMSt", drVBMSt);
        db.addUIntBE("drAllocPtr", drAllocPtr);
        db.addUIntBE("drNmAlBlks", drNmAlBlks);
        db.addUIntBE("drAlBlkSiz", drAlBlkSiz);
        db.addUIntBE("drClpSiz", drClpSiz);
        db.addUIntBE("drAlBlSt", drAlBlSt);
        db.addUIntBE("drNxtCNID", drNxtCNID);
        db.addUIntBE("drFreeBks", drFreeBks);
        db.addUIntBE("drVNLength", drVNLength);
        db.add("drVN", new ASCIIStringField(drVN));
        db.add("drVolBkUp", new HFSDateField(drVolBkUp));
        db.addUIntBE("drVSeqNum", drVSeqNum);
        db.addUIntBE("drWrCnt", drWrCnt);
        db.addUIntBE("drXTClpSiz", drXTClpSiz);
        db.addUIntBE("drCTClpSiz", drCTClpSiz);
        db.addUIntBE("drNmRtDirs", drNmRtDirs);
        db.addUIntBE("drFilCnt", drFilCnt);
        db.addUIntBE("drDirCnt", drDirCnt);
        db.addIntArray("drFndrInfo", drFndrInfo, BITS_32, UNSIGNED, BIG_ENDIAN);
        db.addUIntBE("drVCSize", drVCSize);
        db.addUIntBE("drVBMCSize", drVBMCSize);
        db.addUIntBE("drCtlCSize", drCtlCSize);
        db.addUIntBE("drXTFlSize", drXTFlSize);
        db.add("drXTExtRec", drXTExtRec.getStructElements());
        db.addUIntBE("drCTFlSize", drCTFlSize);
        db.add("drCTExtRec", drCTExtRec.getStructElements());
