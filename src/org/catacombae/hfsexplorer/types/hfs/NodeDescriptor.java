...
public class NodeDescriptor {
    ...
    public int getNdFLink() { return Util.readIntBE(ndFLink); }
    /** backward link (LongInt) */
    public int getNdBLink() { return Util.readIntBE(ndBLink); }
    /** node type (SignedByte) */
    public byte getNdType() { return Util.readByteBE(ndType); }
    /** node level (SignedByte) */
    public byte getNdNHeight() { return Util.readByteBE(ndNHeight); }
    /** number of records in node (Integer) */
    public short getNdNRecs() { return Util.readShortBE(ndNRecs); }
    /** reserved (Integer) */
    public short getNdResv2() { return Util.readShortBE(ndResv2); }
